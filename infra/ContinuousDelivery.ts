...
class Stack extends cdk.Stack {
  constructor(scope: constructs.Construct) {
    ...
    const { role } = new GithubActionsAccessRole(this, 'GithubActionsAccessRole', {
      ...
      githubRepositories: ["rce/payment-receipt-scanner-demo"],
    })
...
class GithubActionsAccessRole extends constructs.Construct {
  role: iam.Role
  constructor(scope: constructs.Construct, id: string, props: GithubActionsAccessRoleProps) {
    super(scope, id)
